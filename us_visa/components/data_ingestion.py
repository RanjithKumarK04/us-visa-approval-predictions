...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)-> DataFrame:
        ...
        Description: This method is used to export data from mongodb into csv file
    ...
    def split_data_into_train_and_test(self, dataframe: DataFrame) -> None:
        """
        Method Name: split_data_into_train_and_test
        Description: This method is used to split data into train and test based on split_ratio
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        Description: This method is used to initiate data ingestion components
